/****************************************************************************
 RoboTerraLightSensor.h
 	Copyright (c) 2015 ROBOTERRA, Inc. All rights reserved.

 Description
 	Header file for RoboTerraLightSensor.cpp 

 ****************************************************************************/

#ifndef RoboTerraLightSensor_h
#define RoboTerraLightSensor_h
...
class RoboTerraLightSensor : public RoboTerraElectronics {
